...
from raysearch.components.crawl.base import CrawlerConfigBase, SpecializedCrawlerBase
...
_CROSSREF_USER_AGENT = "raysearch-doi-crawler/1.0 (mailto:contact@example.com)"
