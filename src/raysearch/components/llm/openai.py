...
from raysearch.components.llm.base import LLMClientBase, LLMConfig, LLMModelConfig
from raysearch.dependencies import Depends
from raysearch.models.components.llm import (
    ChatDictResult,
    ChatModelResult,
    ChatResultBase,
    ChatTextResult,
...
class OpenAIClient(LLMClientBase[OpenAIModelConfig]):
    _SCHEMA_NAME = "RaySearchOverview"
