    ...
    return [
        ...
        },
        {
            ...
            "content": (
                ...
                "- Example A: SpaceX2026年有哪些技术进展 -> detected_input_language=zh-Hans, search_language=en.\n"
                "- Example B: 上海旅行攻略 -> detected_input_language=zh-Hans, search_language=zh-Hans.\n"
                "- Example C: パリ旅行ガイド -> detected_input_language=ja, search_language=ja.\n\n"
